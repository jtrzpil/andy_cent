...
path_row = pd.read_csv('E:\sceny_path_row.csv')
cloud_0_10 = pd.read_csv('E:\cloud_010_OT_ETM_TM.csv')
...
for pr_tuple in path_row_dict.values():
    ...
    currentScene.to_csv(r'E:\sceny\pr_{}_{}.csv'.format(pr_tuple[0], pr_tuple[1]))
    ...
    df_currentView.to_csv(r'E:\sceny_df\df_{}_{}.csv'.format(pr_tuple[0], pr_tuple[1]))